...
import om.example.om_pay.controller.UtilisateurController;

@RestControllerAdvice(assignableTypes = UtilisateurController.class)
public class UtilisateurResponseInterceptor implements ResponseBodyAdvice<Object> {

    private static final Map<String, String> METHOD_MESSAGES = Map.ofEntries(
        Map.entry("updateUtilisateur", "Utilisateur mis à jour avec succès"),
        Map.entry("changeCodePin", "Code PIN changé avec succès")
    );
